@extends('site.master')
@section('title','Single Project | '.env('APP_NAME'))
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9 col-md-12 col-12 text-center">
                    <div class="page-banner-content">
                        <h1 class="display-4 font-weight-bold">Rappo Business Template</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="project-lg-img">
                                <img src="{{ asset('image/projects/'.$project->image) }}" alt="" class="img-fluid w-100">
                            </div>
                    ...
                    <div class="row justify-content-center mt50">
                        ...
                        <div class="col-lg-6">
                            <img src="{{ asset('siteasset/images/projects/2-min.jpg') }}" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
